...
def TakeImage(l1, l2, haarcasecade_path, trainimage_path, message, err_screen,text_to_speech):
    if (l1 == "") and (l2==""):
        ...
        try:
            ...
            path = os.path.join("C:\\Users\\pk877\\OneDrive\\Desktop\\FAS\\AMS\\TrainingImage", directory)
            os.mkdir(path)
            while True:
                ret, img = cam.read()
            ...
            row = [Enrollment, Name]
            with open(
                "C:\\Users\\pk877\\OneDrive\\Desktop\\FAS\\AMS\\StudentDetails\\studentdetails.csv",
                "a+",
            ) as csvFile:
